"""
main_navigator.py
Main entry-point landing screen for Class Pulse (Class Assistant).
...
class MainNavigator:
    def __init__(self):
        ...
        self.root.title("Class Pulse — Portal Navigator")
        self.root.resizable(False, False)
        self.root.configure(fg_color=BG_WINDOW)

        # ---- Live Clock Badge ----
        self.clock_label = ctk.CTkLabel(
            self.root, text="", font=ctk.CTkFont(family="Arial", size=12, weight="bold"),
        ...
        # Unique Main Heading
        self.title_label = ctk.CTkLabel(
            self.header, text="Class Pulse Portal",
        ...
        self.card_area = ctk.CTkFrame(self.root, fg_color="transparent", width=CARD_W, height=380)
        self.card_area.pack(pady=(25, 0))
        ...
        self.footer = ctk.CTkLabel(
            self.root, text="class_assistant  •  v1.0",
    ...
    def open_admin_login(self):
        self.root.destroy()
        app = admin_login.AdminLogin()
        app.root.mainloop()

    def open_student_login(self):
        self.root.destroy()
        app = user_login.userLogin()
        app.root.mainloop()
