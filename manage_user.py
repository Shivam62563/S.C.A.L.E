...
class Demo:
    def __init__(self, parent=None):
        ...
        for i in columns:
            ...
            self.student_table.column(i, anchor="center")

        self.student_table.pack(pady=15, padx=15, expand=True, fill='both')
    ...
    def update(self):
        ...
        self.txt6 = ctk.CTkEntry(self.card_frame, width=220, height=35, corner_radius=8)
        self.txt6.grid(row=6, column=1, padx=(0, 20), pady=8)
        self.txt6.insert(0, self.item[6])
